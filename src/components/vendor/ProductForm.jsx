      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            ...
            <label htmlFor="image-upload" className="relative flex flex-col items-center justify-center w-full h-32 rounded-2xl border-2 border-dashed border-[#0B2E2A]/15 hover:border-primary hover:bg-primary/5 cursor-pointer transition-all overflow-hidden">
          ...
          {/* Name */}
          <div>
            <Label htmlFor="product-name" className="text-sm font-medium text-[#0B2E2A] mb-1.5 block">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <Label htmlFor="product-price" className="text-sm font-medium text-[#0B2E2A] mb-1.5 block">
            ...
            <div>
              <Label htmlFor="product-stock" className="text-sm font-medium text-[#0B2E2A] mb-1.5 block">
                Stock
              </Label>
              <Input
                id="product-stock"
          ...
          {/* Category */}
          <div>
            <Label htmlFor="product-category" className="text-sm font-medium text-[#0B2E2A] mb-1.5 block">
              Category
            </Label>
            <select
              id="product-category"
          ...
          {/* Description */}
          <div>
            <Label htmlFor="product-description" className="text-sm font-medium text-[#0B2E2A] mb-1.5 block">
              Description
            </Label>
            <Textarea
